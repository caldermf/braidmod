...
This directory contains material that was useful during research but does not
belong in the public-facing top-level repo.

Examples:

- abandoned or secondary experiments
...
`figures/` are the intended public surface.
